...
# Forkserver workers inherit their environment before architecture-based config
# finalization, so publish the graph mode alongside the profile that requires it.
