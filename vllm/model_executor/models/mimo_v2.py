...
class MiMoV2Attention(nn.Module):
    def __init__(
        ...
        # MiMo has asymmetric K/V dims (head_dim=192, v_head_dim=128). The
        # known-good DFlash path pads V for Triton/FA-style attention caches and
        # slices the attention output back before o_proj. DiffKV is valid for
        # target-only serving, but it changes draft/target DFlash fidelity.
