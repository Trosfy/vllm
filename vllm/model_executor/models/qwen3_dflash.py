    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            if loaded_weight.is_cuda:
                # The loader retains tensors until name mapping completes.
                # Streaming loaders can recycle their device staging buffer,
                # so retained tensors require independent storage.
