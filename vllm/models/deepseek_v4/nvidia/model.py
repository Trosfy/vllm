...
def _select_dsv4_attn_cls(vllm_config: VllmConfig) -> type[DeepseekV4Attention]:
    ...
    FlashInfer sparse path, including the SM120 implementation on consumer
    Blackwell. Without that explicit override, SM120 defaults to the b12x sparse
    MLA path; otherwise FlashMLA is used.
    """
