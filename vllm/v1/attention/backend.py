...
def exact_attention_metadata_cache_key(
    ...
    return (
        ...
        _tensor_view_cache_key(cm.rswa_prefix_lens),
        _tensor_view_cache_key(cm.replayssm_decode_base_cpu),
        _tensor_view_cache_key(cm._seq_lens_cpu),
        _tensor_view_cache_key(cm._num_computed_tokens_cpu),
