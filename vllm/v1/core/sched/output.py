...
class CachedRequestData:
    ...
    # Complete block-table rows carried in new_block_ids. This is deliberately
    # separate from resumed_req_ids so recurrent-state bookkeeping is retained.
    block_ids_to_overwrite: set[str] = field(default_factory=set)
    ...
    def anon_repr(self) -> str:
        ...
        return (
            ...
            f"block_ids_to_overwrite={self.block_ids_to_overwrite}"
            f")"
        )
